...
logocenter_name: images/qr-code-removebg-preview.png
column_number: 1
output: 
...
\[ p = 0.044\]
<center>
<font size="8">A custom Pagel94 model described the evolution between lifestyle and gene copy number better than the null model would</font> <br>
</center>
